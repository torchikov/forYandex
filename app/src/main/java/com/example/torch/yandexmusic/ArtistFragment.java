...
public class ArtistFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mArtist = ArtistLab.get().getArtistById(artistId);


        View v = inflater.inflate(R.layout.artist_fragment, container, false);


        mBigCoverImageView = (ImageView) v.findViewById(R.id.artist_big_cover_image_view);
        ...
        ImageLoader imageLoader = PicturesUtils.getImageLoader(getActivity().getApplicationContext());
        imageLoader.displayImage(mArtist.getBigCoverUrl(), mBigCoverImageView);
